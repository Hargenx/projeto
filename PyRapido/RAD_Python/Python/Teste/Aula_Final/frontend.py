...
l1 = Label(root, text="Titulo", bg='light sky blue', fg='#6006ff')
l1.grid(row=0, column=0)
l2 = Label(root, text="Autor", bg='light sky blue', fg='#6006ff')
l2.grid(row=0, column=2)
l3 = Label(root, text="Ano", bg='light sky blue', fg='#6006ff')
l3.grid(row=2, column=0)
l4 = Label(root, text="ISBN", bg='light sky blue', fg='#6006ff')
