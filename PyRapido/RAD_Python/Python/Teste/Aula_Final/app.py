...
root.resizable(0,0)
root.iconbitmap("Python\Teste\Aula_Final\icons8_user.ico")
...
janela_alterar = None
janela_incluir = None
caminho_db = "Python\Teste\Aula_Final\contatos.db"
...
def selecionar_dado(event):
    ...
    # --------- BOTÃO - ATUALIZAR -------------
    bttn_updatecom = Button(form_contato, text="Atualizar",
...
def inserir_dados():
    ...
    endereco_entry.grid(row=4, column=1)
    # --------- BOTÃO - CADASTRAR -------------
    bttn_submitcom = Button(form_contato, text="Cadastrar",
...
# --------------- BUTTONS PRINCIPAL --------------
bttn_add = Button(midleft, text="INSERIR", bg="royal blue", command=inserir_dados)
bttn_add.pack()
